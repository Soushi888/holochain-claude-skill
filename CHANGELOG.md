...
- Sweettest (Rust-native) patterns in `Testing.md` — three-layer testing strategy and E2E Playwright integration
- Multi-platform installation section in `README.md` covering Claude Code, GitHub Copilot, Cursor, Augment, and Codex
- Pre-release testing plan in `docs/testing.md`
...
- Expanded Unyt sub-skill description in `docs/roadmap.md`
...
- `Patterns.md` — entry types, link types, CRUD patterns, update chain, validation, signals, HDK 0.4 API
